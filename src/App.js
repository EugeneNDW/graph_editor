...
const App = () => {
    ...
    useEffect(() => {
        setCurrentNode  (graph.getCurrentNodeWithOptions())
        ...
        <>       
            <div className="container mt-5">
                ...
                (
                    <>
                        <div className="row">
                            <h1>THERE IS NO CURRENT NODE</h1>
                            <form>
                                <div className="form-floating">
                                    <input
                                        id="node-character-input"
                            ...
                            <button className="btn btn-block btn-primary" onClick={(e) => {submitFirstNodeForm()}}>Submit</button>
                        </div>
                    </>
                )}
            </div>
